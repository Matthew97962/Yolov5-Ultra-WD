...
def train(hyp, opt, device, callbacks):
    """
7    Trains YOLOv5 model with given hyperparameters, options, and device, managing datasets, model architecture, loss
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if opt.image_weights:
            cw = model.class_weights.gpu().numpy() * (1 - maps) ** 2 / nc  # class weights
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/P-stop.yaml", help="dataset.yaml path")
