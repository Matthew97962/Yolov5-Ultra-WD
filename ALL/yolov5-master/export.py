...
def run(
    data=ROOT / "data/zhjt.yaml",  # 'dataset.yaml path'
    weights=ROOT / "zhjt6lei.pt",  # weights path
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/zhjt.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "zhjt6lei.pt", help="model.pt path(s)")
